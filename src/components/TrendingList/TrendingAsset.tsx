...
function TrendingAsset(props: {data: SingleAsset, meta: Meta}) {
  ...
  return (
    <div className="relative min-w-[220px] md:my-2 sm:my-4 my-8 max-w-[300px] mx-auto">
      <div className="absolute w-fit inset-x-0 mx-auto z-10 rounded-full -top-6 p-px bg-gradient-to-b from-border-grad-one to-border-grad-two">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="80" viewBox="0 0 291 80" fill="none">
        ...
        <linearGradient id="gradientMain" x1="145.37" y1="0.920044" x2="145.37" y2="377" gradientUnits="userSpaceOnUse">
        <stop stop-color="#626A88"/>
        <stop offset="1" stop-color="#2E3149"/>
        </linearGradient>
        <linearGradient id="gradientBorder" x1="145.37" y1="0.920044" x2="145.37" y2="377" gradientUnits="userSpaceOnUse">
